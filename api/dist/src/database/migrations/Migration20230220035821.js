...
exports.Migration20230220035821 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20230220035821 extends migrations_1.Migration {
    async up() {
        ...
        this.addSql('create table "recipes_categories" ("recipe_id" int not null, "recipe_category_id" int not null, constraint "recipes_categories_pkey" primary key ("recipe_id", "recipe_category_id"));');
        this.addSql('create table "users" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "username" varchar(255) not null, "password" varchar(255) not null, "first_name" varchar(255) null, "last_name" varchar(255) null);');
        ...
        this.addSql('create table "refresh_tokens" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "user_id" int not null, "is_revoked" boolean not null default false, "expires" timestamptz(0) not null);');
        ...
        this.addSql('create table "tasks" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" varchar(255) not null, "description" varchar(255) null, "created_by_id" int not null, "list_id" int not null, "complete" boolean not null default false);');
        this.addSql('alter table "recipes_categories" add constraint "recipes_categories_recipe_id_foreign" foreign key ("recipe_id") references "recipes" ("id") on update cascade on delete cascade;');
        this.addSql('alter table "recipes_categories" add constraint "recipes_categories_recipe_category_id_foreign" foreign key ("recipe_category_id") references "category" ("id") on update cascade on delete cascade;');
    ...
    async down() {
        this.addSql('alter table "recipes_categories" drop constraint "recipes_categories_recipe_id_foreign";');
        this.addSql('alter table "recipes_categories" drop constraint "recipes_categories_recipe_category_id_foreign";');
        this.addSql('alter table "rooms" drop constraint "rooms_created_by_id_foreign";');
...
exports.Migration20230220035821 = Migration20230220035821;
//# sourceMappingURL=Migration20230220035821.js.map
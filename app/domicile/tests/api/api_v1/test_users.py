...
from app.domicile import crud
from app.domicile.core.config import settings
from app.domicile.schemas.user import UserCreate
from app.domicile.tests.utils.utils import random_email, random_lower_string
...
def test_create_user_new_email(
    ...
    r = client.post(
        f"{settings.API_V1_STR}/users/", headers=admin_user_token_headers, json=data
    )
...
def test_retrieve_users(
    ...
    r = client.get(f"{settings.API_V1_STR}/users/", headers=admin_user_token_headers)
    all_users = r.json()

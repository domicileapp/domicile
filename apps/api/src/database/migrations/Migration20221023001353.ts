...
export class Migration20221023001353 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "tasks" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" varchar(255) not null, "description" varchar(255) null, "created_by_id" int not null, "list_id" int not null);',
    )
  ...
  async down(): Promise<void> {
    this.addSql(
      'create table "todos" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" varchar(255) not null, "description" varchar(255) null, "created_by_id" int not null, "list_id" int not null);',
    )

            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_domicileapp_domicile_internal_db.RecipeIngredient"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_domicileapp_domicile_internal_db.RecipeInstruction"
                        }
                    }
                }
            }
